...
def main():
  ...
  if executionMode == "REPROCESS":
    ...
    scan_kwargs['FilterExpression'] = Attr("processingState").eq("consensus") | Attr("pangoCallDate").not_exists() | Attr("lqpCallDate").not_exists() | Attr("genotypeVariant").not_exists()

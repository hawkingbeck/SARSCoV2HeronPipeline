...
def main():
  ...
  if executionMode == "REPROCESS":
    ...
    scan_kwargs['FilterExpression'] = Attr("processingState").eq("consensus") | Attr("armadillinCallDate").not_exists() | Attr("pangoCallDate").not_exists() | Attr("genotypeCallDate").not_exists()
